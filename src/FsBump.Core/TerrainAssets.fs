...
module TerrainAssets =
    ...
    let platforms = [|
        "platform_1x1x1"; "platform_1x1x2"; "platform_1x1x4"
        ...
        "platform_arrow_2x2x1"; "platform_arrow_4x4x1"; "platform_arrow_6x6x1"
        "platform_hole_6x6x1"
    |]
    ...
    let barriers = [|
        ...
        "barrier_column_1x1x2"; "barrier_column_1x1x4"
        "barrier_corner_1x1x1"; "barrier_corner_1x1x2"; "barrier_corner_1x1x4"
    |]
    ...
    let interactive = [|
        "spring_pad"; "button_base"; "button_base_small"
        "lever_floor_base"; "lever_wall_base_A"; "lever_wall_base_B"
        "power"
    |]
    ...
    let getAssetsByMode (modeName: string) =
        ...
        | "Infinite" ->
            // Balanced mix
            Array.concat [| platforms; slopes; barriers; arches; interactive; collectibles; decorations |]
        | _ ->
            Array.concat [| platforms; slopes |]